package com.minlukj.wanandroid.utils;
...
public final class BarUtils {
    ...
    /**
     * Set the status bar's visibility. 设置状态栏可见性
     *
     * @param activity  The activity.
     * @param isVisible True to set status bar visible, false otherwise.设置为true时显示状态栏，否则为false
     */
    ...
    /**
     * Set the status bar's visibility.设置状态栏的可见性。
     *
     * @param window    The window.
     * @param isVisible True to set status bar visible, false otherwise.如果设置为true，则状态栏可见；否则，设置为false。
     */
    ...
    /**
     * Return whether the status bar is visible.返回状态栏是否可见。
     *
     * @param activity The activity.
    ...
    /**
     * Set the status bar's light mode.设置状态栏的灯光模式。
     *
     * @param activity    The activity.
     * @param isLightMode True to set status bar light mode, false otherwise.设置状态栏指示灯模式为True，否则为false。
     */
    ...
    /**
     * Is the status bar light mode.状态栏是灯光模式。
     *
     * @param activity The activity.
     * @return {@code true}: yes<br>{@code false}: no
     */
    ...
    /**
     * Add the top margin size equals status bar's height for view.添加顶部边距大小等于状态栏的高度以进行查看。
     *
     * @param view The view.
     */
    ...
    /**
     * Subtract the top margin size equals status bar's height for view.减去顶部边距大小等于状态栏的高度以进行查看。
     *
     * @param view The view.
     */
    ...
    /**
     * Set the status bar's color.设置状态栏的颜色。
     *
     * @param activity The activity.
    ...
    /**
     * Set the custom status bar.设置自定义状态栏。
     *
     * @param fakeStatusBar The fake status bar view.
     */
    ...
    /**
     * Set the status bar's color for DrawerLayout.为DrawerLayout设置状态栏的颜色。
     * <p>DrawLayout must add {@code android:fitsSystemWindows="true"}</p>DrawLayout必须添加{@code android：fitsSystemWindows =“ true”}
     *
    ...
    /**
     * Set the status bar's color for DrawerLayout.设置状态栏的颜色为DrawerLayout。
     * <p>DrawLayout must add {@code android:fitsSystemWindows="true"}</p>DrawLayout必须添加{@code android：fitsSystemWindows =“ true”}
     *
     * @param drawer        The DrawLayout.
     * @param fakeStatusBar The fake status bar view.
    ...
    /**
     * Return the action bar's height.返回操作栏的高度。
     *
    ...
    /**
     * Set the notification bar's visibility.设置通知栏的可见性。
     * <p>Must hold {@code <uses-permission android:name="android.permission.EXPAND_STATUS_BAR" />}</p>
     * 必须保留{@code <uses-permission android：name =“ android.permission.EXPAND_STATUS_BAR” />}
    ...
    /**
     * Return the navigation bar's height.返回导航栏的高度。
     *
    ...
    /**
     * Set the navigation bar's visibility.设置导航栏的可见性。
     *
     * @param activity  The activity.
    ...
    /**
     * Return whether the navigation bar visible.返回导航栏是否可见。
     * <p>Call it in onWindowFocusChanged will get right result.</p>在onWindowFocusChanged中调用它会得到正确的结果。
     *
     * @param activity The activity.
     * @return {@code true}: yes<br>{@code false}: no
     */
    ...
    /**
     * Set the navigation bar's color.设置导航栏的颜色。
     *
     * @param activity The activity.
    ...
    /**
     * Set the navigation bar's color.设置导航栏上的颜色。
     *
     * @param window The window.
     * @param color  The navigation bar's color.
     */
    ...
    /**
     * Return the color of navigation bar.返回导航栏的颜色。
     *
     * @param activity The activity.
